...
echo "$($PSQL "select major from students full join majors on students.major_id = majors.major_id where students.major_id is null or first_name ilike '%ma%' order by major asc")"
